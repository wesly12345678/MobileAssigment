...
//
//     val user = User(uid.toString(),name.text.toString(),email.text.toString(),password.text.toString(),Cpassword.text.toString())
//     ref.child(uid.toString()).setValue(user).addOnSuccessListener {
//         Toast.makeText(baseContext,"Save successfully.",Toast.LENGTH_SHORT).show()
//     }
//    }
